...
class ClientPrefs {
	...
	public static var subtitles = true;
	...
	public static function saveSettings() {
		...
		save.bind('FUNNYING_controls', 'funnyboyfriend'); //Placing this in a separate save so that it can be manually deleted without removing your Score and stuff
	...
	public static function loadPrefs() {
		...
		var save:FlxSave = new FlxSave();
		save.bind('FUNNYING_controls', 'funnyboyfriend');
	...
	inline public static function getGameplaySetting(name:String, defaultValue:Dynamic):Dynamic { return gameplaySettings.exists(name) ? gameplaySettings.get(name) : defaultValue; }
