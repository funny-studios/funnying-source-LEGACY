...
class WeekEditorState extends MusicBeatState
{
	...
	override function create() {
		...
		var tracksSprite:FlxSprite = new FlxSprite(FlxG.width * .07, bgSprite.y + 435).loadGraphic(Paths.image('Menu_Tracks'));
	...
	function addOtherUI() {
		...
		tab_group.add(new FlxText(difficultiesInputText.x, difficultiesInputText.y + 20, 0, 'Default difficulties are "Easy, Normal, Raw"\nwithout quotes.'));
