...
class CoolUtil
{
	...
	public static function precacheRawSound(sound:String) { if (!Assets.cache.hasSound(sound)) FlxG.sound.cache(sound); }
	public static function precacheAsset(asset:String):Void { if (!Assets.cache.hasBitmapData(asset)) FlxG.bitmap.add(asset); }
	//uhhhh does this even work at all? i'm starting to doubt
	public static function precacheSound(sound:String, ?library:String = null):Void { precacheRawSound(Paths.sound(sound, library)); }
