...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Funny BF Team'],
			['Daniyar Gaming',		'daniyar',			'Director/Artist',										'https://twitter.com/GamingDaniyar',	'77ADFF'],
			['Top 10 Awesome',		'top_10',			'Main Composer\n[ Gastric Bypass, Roided, Cervix, Funny Duo, jn.ogg ]',							'https://www.youtube.com/c/Top10Awesome',	'FFF200'],
			['Pandemonium',			'pandemonium',		'Main Programmer/Main Animator/Composer\n[ Kleptomaniac, Relapse, Banana, SQUIDGAMES ]',		'https://twitter.com/Paracosm_Daemon',	'323547'],
			['Crash',				'crash',			'Main Artist/Animator',									'https://twitter.com/SUSCRASH',			'D7023D'],
	...
	function changeSelection(change:Int = 0)
	{
		...
		do { curSelected = CoolUtil.repeat(curSelected, change, creditsStuff.length); } while (unselectableCheck(curSelected));
		...
		for (item in grpOptions.members)
		{
			...
			{
				item.alpha = .6;
				if (Math.floor(item.targetY) == 0) item.alpha = 1;
			}
		}
