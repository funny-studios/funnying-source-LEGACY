...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		optionsArray.push(option);
		#end
		var option:GameplayOption = new GameplayOption('Pussy Mode', 'botplay', 'bool', false);
		optionsArray.push(option);
	}
	...
	public function new()
	{
		...
		{
			var optionText:Alphabet = new Alphabet(0, 70 * i, optionsArray[i].name, true, false, .05, .8);
			...
			{
				var valueText:AttachedText = new AttachedText('' + optionsArray[i].getValue(), optionText.width + 80, true, .8);
